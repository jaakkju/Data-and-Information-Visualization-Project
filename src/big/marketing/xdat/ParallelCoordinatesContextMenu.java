...
/**
 * A context menu for the parallel coordinates chart that is opened upon right-click.
 * <p> This makes it easier to edit axis-specific settings.
 */
public class ParallelCoordinatesContextMenu extends JPopupMenu {
	 ...
	 * @param axis the axis
	 */
	public ParallelCoordinatesContextMenu(Axis axis, ParallelCoordinatesChartPanel parallelCoordinatesChartPanel) {
		super();
		this.add(new JLabel(" Axis settings: " + axis.getName()));
		this.add(new Separator());

		ParallelChartContextMenuActionListener cmd = new ParallelChartContextMenuActionListener(axis, parallelCoordinatesChartPanel);
