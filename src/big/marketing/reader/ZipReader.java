...
public class ZipReader {
	 ...
	 * @throws IOException
	 */
	private List<InputStream> getZipInputStreams(String zipFile, String streamName) throws IOException {
	 ...
	 * @throws ParseException is thrown when date cannot be parsed
	 */
	public int readCSVStream(InputStream in, DataType type) throws IOException, ParseException {
	 ...
	 * @throws ParseException is thrown when date cannot be parsed
	 */
	private DBWritable createDataStructure(String[] entry, DataType type) throws ParseException {
		DBWritable out = null;
	...
	public void read(DataType... types) throws ParseException, IOException {
	 ...
	 * @throws IOException is thrown when IOException occurs within the Inputstream
	 */
	public void read(DataType type, int week) throws ParseException, IOException {
